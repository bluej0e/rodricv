    ...
    jQuery(document).on('ready', function() {
        ...
        function initPortfolio() {
            ...
            $('li.list-shuffle,#add-more').on('click', function() {
                ...
                $("div.inBottom").removeClass('InBottom').hide().addClass('InBottom').show();
                $("div.inBottomRight").removeClass('InBottomRight').hide().addClass('InBottomRight').show();
                $("div.inBottomLeft").removeClass('InBottomLeft').hide().addClass('InBottomLeft').show();
            });
        ...
        //     var mapOptions = {
        //         zoom: 17,
        //         center: new google.maps.LatLng(41.4306423, 2.1850674),
